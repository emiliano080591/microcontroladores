...
unsigned char tecla=16,lectura=0, tecla_anterior=0;
const char tabla7segmentos [17]={0x3f,0x06,0x5b,0x4f,0x66,0x6d,0x7d,0x07,0x7f,0x6f,0x77,0x7C,0x39,0x5E,0x79,0x71,0x00};
